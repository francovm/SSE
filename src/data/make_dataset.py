...
stations_list = open("/home/francovm/Projects/SSE/data/external/MAHI.txt").read().splitlines()
...
input_data.to_csv('/home/francovm/Projects/SSE/data/processed/MAHI.csv', sep='\t', encoding='utf-8',index=False)
